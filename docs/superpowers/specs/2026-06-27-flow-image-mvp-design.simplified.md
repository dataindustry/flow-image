# FlowImage MVP Design (Simplified Review Artifact)

**Date:** 2026-06-27
**Status:** Simplified MVP review artifact (round 3)
**Workspace:** `/Users/ryu/projects/AgenticProjects/like-water/flow-image`
**Relationship to prior drafts:** This file is retained as the simplified review artifact that informed `2026-06-27-flow-image-mvp-design.md`. Design principle for this round: **meet the functional requirements with the least possible surface; subtract before adding.**
