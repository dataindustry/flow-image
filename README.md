...
```bash
PUBLIC_BASE_URL=http://127.0.0.1:3939 corepack pnpm@11.7.0 dev:backend
```
...
PORT=3939
BIND_HOST=0.0.0.0
PUBLIC_BASE_URL=http://<server-lan-ip>:3939
```
...
Then configure the plugin on each Codex computer:
